...
struct Color: Equatable {
    ...
    static var purple: Color = .init(r: 8, g: 0, b: 8)
    static var yellow: Color = .init(r: 16, g: 16, b: 0)
    static var cyan: Color = .init(r: 0, g: 16, b: 16)
    ...
    static var purple: Color = .init(r: 2, g: 0, b: 2)
    static var yellow: Color = .init(r: 16, g: 16, b: 0)
    static var cyan: Color = .init(r: 0, g: 16, b: 16)
